...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      "Every assets on our platform is verified by our team to ensure our highest quality standard. Not happy? We offer a 30 days money back guarantee.",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
            ...
            {perks.map((perk) => (
              ...
              >
                <div className="md:flex-shrink-0 flex justify-center">
                  <div className="h-16 w-16 flex items-center justify-center rounded-full bg-rose-100">
